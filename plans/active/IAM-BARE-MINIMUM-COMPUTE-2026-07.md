...
| Hosted shell (OpenAI `/mnt/data`) | **GREEN** | Fabrication blocked + empty-recover **cap** synthesizes visible reply (`95774399`); dual-pass exact in-app prompt `9323a168` / `b9524a66` | OpenAI | `95774399` |
