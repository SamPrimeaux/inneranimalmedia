...
| Hosted shell (OpenAI `/mnt/data`) | **GREEN** | Fabrication + **blocking** silent-exhaustion closed (`tkt_hosted_shell_silent_exhaustion` → then `tkt_hosted_shell_executor_contract`). Cap synthesizes reply. | OpenAI | `95774399` |
