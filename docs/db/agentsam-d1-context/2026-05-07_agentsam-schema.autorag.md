...
<!-- chunk:table name=agentsam_agent_run scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_agent_run

table_name: `agentsam_agent_run`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
row_count: `312`
tags: `agentsam, d1, execution, schema`

retrieval_summary:
- Purpose: High-level agent invocation/run record for status, model, cost, token, and workflow tracking.
- Use table `agentsam_agent_run` only with the columns listed below.
...
<!-- chunk:table name=agentsam_ai scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_ai

table_name: `agentsam_ai`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
row_count: `112`
tags: `agentsam, d1, models-routing-evals, schema`

retrieval_summary:
- Purpose: AI model/provider catalog and model capability metadata.
- Use table `agentsam_ai` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  },
  {
    ...
    "type": "TEXT",
    "notnull": 1,
    "dflt_value": "'multi_tenant'",
    "pk": 0
  },
  {
    "cid": 10,
    "name": "allowed_tenants_json",
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'[]'",
    "pk": 0
  ...
  },
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'zero_trust_plus_oauth'",
    "pk": 0
  },
  {
    "cid": 13,
    "name": "required_roles_json",
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'[\"super_admin\"]'",
    "pk": 0
  },
  {
    "cid": 14,
  ...
  {
    "cid": 36,
    "name": "additional_alert_emails_json",
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'[]'",
    "pk": 0
  ...
  {
    "cid": 74,
    "name": "cache_write_rate_per_mtok",
    "type": "REAL",
    "notnull": 0,
    "dflt_value": null,
    "pk": 0
...
<!-- chunk:table name=agentsam_analytics scope=agentsam-platform group=observability-analytics tags=agentsam,analytics,d1,observability-analytics,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_analytics

table_name: `agentsam_analytics`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `observability-analytics`
group_title: `Observability, Analytics, Health, and Errors`
row_count: `3`
tags: `agentsam, analytics, d1, observability-analytics, schema`

retrieval_summary:
- Purpose: Analytics snapshot/rollup table for Agent Sam usage, costs, tools, and system health.
- Use table `agentsam_analytics` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'aan_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
  ...
  {
    "cid": 7,
    "name": "most_failed_tool_failure_rate",
    "type": "REAL",
    "notnull": 0,
    "dflt_value": "0",
    "pk": 0
  ...
  {
    "cid": 11,
    "name": "overall_tool_success_rate",
    "type": "REAL",
    "notnull": 0,
    "dflt_value": "0",
    "pk": 0
...
<!-- chunk:table name=agentsam_approval_queue scope=agentsam-platform group=security-governance tags=agentsam,approval,d1,schema,security-governance generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_approval_queue

table_name: `agentsam_approval_queue`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `security-governance`
group_title: `Security, Guardrails, Policy, and Approvals`
row_count: `2`
tags: `agentsam, approval, d1, schema, security-governance`

retrieval_summary:
- Purpose: Human approval queue for risky or gated tool/command actions.
- Use table `agentsam_approval_queue` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'appr_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_artifacts scope=agentsam-platform group=other tags=agentsam,d1,other,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_artifacts

table_name: `agentsam_artifacts`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `other`
group_title: `Other agentsam_* Tables`
row_count: `3`
tags: `agentsam, d1, other, schema`

retrieval_summary:
- Purpose: agentsam table in the Other agentsam_* Tables domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, tenant_id, workspace_id, name, description, artifact_type, r2_key.
- Use table `agentsam_artifacts` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'art_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_bootstrap scope=agentsam-platform group=workspace-projects tags=agentsam,d1,schema,workspace-projects generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_bootstrap

table_name: `agentsam_bootstrap`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `workspace-projects`
group_title: `Workspaces, Projects, and Subagents`
row_count: `12`
tags: `agentsam, d1, schema, workspace-projects`

retrieval_summary:
- Purpose: agentsam table in the Workspaces, Projects, and Subagents domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workspace_id, tenant_id, brand_id, user_id, session_id, email, role_slug.
- Use table `agentsam_bootstrap` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  {
    "cid": 18,
    "name": "allowed_execution_modes_json",
    "type": "TEXT",
    "notnull": 1,
    "dflt_value": "'[\"pty\"]'",
    "pk": 0
...
<!-- chunk:table name=agentsam_browser_trusted_origin scope=agentsam-platform group=security-governance tags=agentsam,d1,schema,security-governance generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_browser_trusted_origin

table_name: `agentsam_browser_trusted_origin`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `security-governance`
group_title: `Security, Guardrails, Policy, and Approvals`
...
retrieval_summary:
- Purpose: agentsam table in the Security, Guardrails, Policy, and Approvals domain. Use the actual columns listed here before writing API SQL. Leading columns: user_id, origin, cert_fingerprint_sha256, trust_scope, created_at, updated_at, person_uuid.
- Use table `agentsam_browser_trusted_origin` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_cad_jobs scope=agentsam-platform group=settings-jobs tags=agentsam,d1,schema,settings-jobs generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_cad_jobs

table_name: `agentsam_cad_jobs`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `settings-jobs`
group_title: `Settings, Feature Flags, and Jobs`
row_count: `2`
tags: `agentsam, d1, schema, settings-jobs`

retrieval_summary:
- Purpose: agentsam table in the Settings, Feature Flags, and Jobs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, session_id, user_id, engine, prompt, mode, status, external_task_id.
- Use table `agentsam_cad_jobs` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_code_index_job scope=agentsam-platform group=settings-jobs tags=agentsam,d1,schema,settings-jobs generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_code_index_job

table_name: `agentsam_code_index_job`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `settings-jobs`
group_title: `Settings, Feature Flags, and Jobs`
...
retrieval_summary:
- Purpose: agentsam table in the Settings, Feature Flags, and Jobs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, workspace_id, status, progress_percent, source_type, source_path, vector_backend.
- Use table `agentsam_code_index_job` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_command_allowlist scope=agentsam-platform group=commands tags=agentsam,command,commands,d1,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_command_allowlist

table_name: `agentsam_command_allowlist`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `commands`
group_title: `Commands and Intent Routing`
row_count: `155`
tags: `agentsam, command, commands, d1, schema`

retrieval_summary:
- Purpose: agentsam table in the Commands and Intent Routing domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, workspace_id, command, created_at, person_uuid.
- Use table `agentsam_command_allowlist` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_command_pattern scope=agentsam-platform group=commands tags=agentsam,command,commands,d1,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_command_pattern

table_name: `agentsam_command_pattern`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `commands`
group_title: `Commands and Intent Routing`
...
retrieval_summary:
- Purpose: agentsam table in the Commands and Intent Routing domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workspace_id, pattern, pattern_type, mapped_command, description, category, risk_level.
- Use table `agentsam_command_pattern` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'pat_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_command_run scope=agentsam-platform group=execution tags=agentsam,command,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_command_run

table_name: `agentsam_command_run`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workspace_id, session_id, conversation_id, user_input, normalized_intent, intent_category, tier_used.
- Use table `agentsam_command_run` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'run_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_commands scope=agentsam-platform group=commands tags=agentsam,command,commands,d1,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_commands

table_name: `agentsam_commands`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `commands`
group_title: `Commands and Intent Routing`
...
retrieval_summary:
- Purpose: Canonical command registry for Agent Sam actions and command routing.
- Use table `agentsam_commands` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  },
  {
    ...
    "type": "TEXT",
    "notnull": 1,
    "dflt_value": "'ws_inneranimalmedia'",
    "pk": 0
  },
  {
    "cid": 2,
...
<!-- chunk:table name=agentsam_compaction_events scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_compaction_events

table_name: `agentsam_compaction_events`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, session_id, provider, model_key, tokens_before, tokens_after, cost_saved_usd.
- Use table `agentsam_compaction_events` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'cmp_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_cron_runs scope=agentsam-platform group=execution tags=agentsam,cron,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_cron_runs

table_name: `agentsam_cron_runs`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, job_name, cron_expression, status, tenant_id, workspace_id, started_at, completed_at.
- Use table `agentsam_cron_runs` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'acr_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_deployment_health scope=agentsam-platform group=observability-analytics tags=agentsam,d1,health,observability-analytics,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_deployment_health

table_name: `agentsam_deployment_health`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `observability-analytics`
group_title: `Observability, Analytics, Health, and Errors`
...
retrieval_summary:
- Purpose: agentsam table in the Observability, Analytics, Health, and Errors domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, deployment_id, worker_name, environment, check_type, check_url, status.
- Use table `agentsam_deployment_health` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'dhc_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_error_log scope=agentsam-platform group=observability-analytics tags=agentsam,d1,error,observability-analytics,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_error_log

table_name: `agentsam_error_log`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `observability-analytics`
group_title: `Observability, Analytics, Health, and Errors`
...
retrieval_summary:
- Purpose: agentsam table in the Observability, Analytics, Health, and Errors domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workspace_id, tenant_id, session_id, error_code, error_type, error_message, source.
- Use table `agentsam_error_log` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'err_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_escalation scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_escalation

table_name: `agentsam_escalation`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, plan_id, todo_id, command_run_id, from_tier, from_model.
- Use table `agentsam_escalation` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'esc_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_eval_cases scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,eval,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_eval_cases

table_name: `agentsam_eval_cases`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: Evaluation cases for model/tool/prompt quality testing.
- Use table `agentsam_eval_cases` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'evc_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_eval_runs scope=agentsam-platform group=execution tags=agentsam,d1,eval,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_eval_runs

table_name: `agentsam_eval_runs`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: Evaluation run results and quality/cost/latency scoring.
- Use table `agentsam_eval_runs` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'evr_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_eval_suites scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,eval,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_eval_suites

table_name: `agentsam_eval_suites`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, name, description, provider, mode, task_type, is_active.
- Use table `agentsam_eval_suites` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'evs_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_execution_context scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_execution_context

table_name: `agentsam_execution_context`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, command_run_id, todo_id, cwd, files_json, recent_error.
- Use table `agentsam_execution_context` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'ctx_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_executions scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_executions

table_name: `agentsam_executions`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, user_id, plan_id, todo_id, command_run_id, task_id.
- Use table `agentsam_executions` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_feature_flag scope=agentsam-platform group=settings-jobs tags=agentsam,d1,feature,schema,settings-jobs generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_feature_flag

table_name: `agentsam_feature_flag`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `settings-jobs`
group_title: `Settings, Feature Flags, and Jobs`
...
retrieval_summary:
- Purpose: agentsam table in the Settings, Feature Flags, and Jobs domain. Use the actual columns listed here before writing API SQL. Leading columns: flag_key, description, enabled_globally, config_json, updated_at, enabled_for_tenants, enabled_for_users, rollout_pct.
- Use table `agentsam_feature_flag` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_fetch_domain_allowlist scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_fetch_domain_allowlist

table_name: `agentsam_fetch_domain_allowlist`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, workspace_id, host, created_at, person_uuid.
- Use table `agentsam_fetch_domain_allowlist` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_guardrail_events scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,guardrail,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_guardrail_events

table_name: `agentsam_guardrail_events`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, event_scope, tenant_id, workspace_id, user_id, identity_profile_id, session_id, conversation_id.
- Use table `agentsam_guardrail_events` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_guardrail_rulesets scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,guardrail,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_guardrail_rulesets

table_name: `agentsam_guardrail_rulesets`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, ruleset_key, title, description, scope, tenant_id, workspace_id, user_id.
- Use table `agentsam_guardrail_rulesets` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_guardrails scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,guardrail,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_guardrails

table_name: `agentsam_guardrails`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: Guardrail rule definitions for safety, governance, and tool/action blocking.
- Use table `agentsam_guardrails` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_health_daily scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,health,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_health_daily

table_name: `agentsam_health_daily`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, day, health_status, snapshot_count, green_count, yellow_count, red_count.
- Use table `agentsam_health_daily` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'ahd_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_hook scope=agentsam-platform group=hooks-webhooks tags=agentsam,d1,hook,hooks-webhooks,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_hook

table_name: `agentsam_hook`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `hooks-webhooks`
group_title: `Hooks and Webhooks`
row_count: `14`
tags: `agentsam, d1, hook, hooks-webhooks, schema`

retrieval_summary:
- Purpose: Hook definitions connecting events to workflows, tools, or commands.
- Use table `agentsam_hook` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_hook_execution scope=agentsam-platform group=execution tags=agentsam,d1,execution,hook,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_hook_execution

table_name: `agentsam_hook_execution`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: Execution records for triggered hooks.
- Use table `agentsam_hook_execution` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'hexec_' || lower(hex(randomblob(6)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_ignore_pattern scope=agentsam-platform group=memory-skills-rules tags=agentsam,d1,memory-skills-rules,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_ignore_pattern

table_name: `agentsam_ignore_pattern`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `memory-skills-rules`
group_title: `Memory, Skills, Rules, and Ignore Patterns`
row_count: `10`
tags: `agentsam, d1, memory-skills-rules, schema`

retrieval_summary:
- Purpose: agentsam table in the Memory, Skills, Rules, and Ignore Patterns domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, workspace_id, pattern, is_negation, order_index, source, created_at.
- Use table `agentsam_ignore_pattern` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_mcp_allowlist scope=agentsam-platform group=mcp-tools tags=agentsam,d1,mcp,mcp-tools,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_mcp_allowlist

table_name: `agentsam_mcp_allowlist`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `mcp-tools`
group_title: `MCP Tools, Servers, and Tool Logs`
row_count: `412`
tags: `agentsam, d1, mcp, mcp-tools, schema`

retrieval_summary:
- Purpose: agentsam table in the MCP Tools, Servers, and Tool Logs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, workspace_id, tool_key, created_at, notes, person_uuid, agentsam_tools_id.
- Use table `agentsam_mcp_allowlist` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_mcp_servers scope=agentsam-platform group=mcp-tools tags=agentsam,d1,mcp,mcp-tools,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_mcp_servers

table_name: `agentsam_mcp_servers`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `mcp-tools`
group_title: `MCP Tools, Servers, and Tool Logs`
...
retrieval_summary:
- Purpose: Registry of MCP servers and health/routing metadata.
- Use table `agentsam_mcp_servers` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'mcps_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_mcp_tool_execution scope=agentsam-platform group=execution tags=agentsam,d1,execution,mcp,schema,tool generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_mcp_tool_execution

table_name: `agentsam_mcp_tool_execution`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tool_id, tool_name, input_tokens, output_tokens, duration_ms, cost_usd, success.
- Use table `agentsam_mcp_tool_execution` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_mcp_tools scope=agentsam-platform group=mcp-tools tags=agentsam,d1,mcp,mcp-tools,schema,tool generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_mcp_tools

table_name: `agentsam_mcp_tools`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `mcp-tools`
group_title: `MCP Tools, Servers, and Tool Logs`
...
retrieval_summary:
- Purpose: Registry of MCP tools and tool schema/risk/health metadata.
- Use table `agentsam_mcp_tools` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_mcp_workflows scope=agentsam-platform group=mcp-tools tags=agentsam,d1,mcp,mcp-tools,schema,workflow generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_mcp_workflows

table_name: `agentsam_mcp_workflows`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `mcp-tools`
group_title: `MCP Tools, Servers, and Tool Logs`
...
retrieval_summary:
- Purpose: agentsam table in the MCP Tools, Servers, and Tool Logs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workflow_key, display_name, description, status, priority, steps_json, tools_json.
- Use table `agentsam_mcp_workflows` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  },
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'{\"max_retries\":2,\"backoff\":\"exponential\",\"delay_ms\":2000,\"retry_on\":[\"timeout\",\"network_error\"]}'",
    "pk": 0
  },
  {
    "cid": 35,
    "name": "on_failure_json",
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'{\"action\":\"notify\",\"notify_channel\":\"resend\"}'",
    "pk": 0
  },
  {
    "cid": 36,
...
<!-- chunk:table name=agentsam_memory scope=agentsam-platform group=memory-skills-rules tags=agentsam,d1,memory,memory-skills-rules,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_memory

table_name: `agentsam_memory`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `memory-skills-rules`
group_title: `Memory, Skills, Rules, and Ignore Patterns`
...
retrieval_summary:
- Purpose: Persistent memory/facts/preferences used for Agent Sam context.
- Use table `agentsam_memory` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'mem_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_model_drift_signals scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,model,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_model_drift_signals

table_name: `agentsam_model_drift_signals`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, model_key, provider, task_type, case_id, baseline_score, baseline_run_id, current_score.
- Use table `agentsam_model_drift_signals` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'mds_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_model_tier scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,model,models-routing-evals,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_model_tier

table_name: `agentsam_model_tier`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workspace_id, tier_level, tier_name, model_id, api_platform, role_description, escalate_if_confidence_below.
- Use table `agentsam_model_tier` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'tier_' || lower(hex(randomblob(6)))",
    "pk": 1
  },
  {
    "cid": 1,
  ...
  {
    "cid": 7,
    "name": "escalate_if_confidence_below",
    "type": "REAL",
    "notnull": 0,
    "dflt_value": "0.75",
    "pk": 0
...
<!-- chunk:table name=agentsam_plan_tasks scope=agentsam-platform group=workflows-plans-tasks tags=agentsam,d1,plan,schema,workflows-plans-tasks generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_plan_tasks

table_name: `agentsam_plan_tasks`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `workflows-plans-tasks`
group_title: `Workflows, Plans, Tasks, and Todos`
row_count: `75`
tags: `agentsam, d1, plan, schema, workflows-plans-tasks`

retrieval_summary:
- Purpose: agentsam table in the Workflows, Plans, Tasks, and Todos domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, plan_id, todo_id, command_run_id, agent_id, assigned_model.
- Use table `agentsam_plan_tasks` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'task_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_plans scope=agentsam-platform group=workflows-plans-tasks tags=agentsam,d1,plan,schema,workflows-plans-tasks generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_plans

table_name: `agentsam_plans`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `workflows-plans-tasks`
group_title: `Workflows, Plans, Tasks, and Todos`
...
retrieval_summary:
- Purpose: agentsam table in the Workflows, Plans, Tasks, and Todos domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, session_id, agent_id, client_id, client_name, plan_date.
- Use table `agentsam_plans` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  },
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'[\"anthropic\",\"openai\",\"google\",\"workers_ai\"]'",
    "pk": 0
  },
  {
    "cid": 15,
...
<!-- chunk:table name=agentsam_project_context scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_project_context

table_name: `agentsam_project_context`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, project_key, project_name, project_type, status, priority.
- Use table `agentsam_project_context` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_prompt_cache_keys scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,models-routing-evals,prompt,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_prompt_cache_keys

table_name: `agentsam_prompt_cache_keys`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, provider, model_key, cache_key_hash, cache_type, token_count, write_cost_usd.
- Use table `agentsam_prompt_cache_keys` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'pck_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_prompt_versions scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,models-routing-evals,prompt,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_prompt_versions

table_name: `agentsam_prompt_versions`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: Versioned system/role/prompt records for rollback and prompt governance.
- Use table `agentsam_prompt_versions` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'pv_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_routing_arms scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,models-routing-evals,routing,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_routing_arms

table_name: `agentsam_routing_arms`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: Model routing state used for provider/model selection and performance tuning.
- Use table `agentsam_routing_arms` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'ra_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_rules_document scope=agentsam-platform group=memory-skills-rules tags=agentsam,d1,memory-skills-rules,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_rules_document

table_name: `agentsam_rules_document`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `memory-skills-rules`
group_title: `Memory, Skills, Rules, and Ignore Patterns`
...
retrieval_summary:
- Purpose: agentsam table in the Memory, Skills, Rules, and Ignore Patterns domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, workspace_id, title, body_markdown, version, is_active, created_at.
- Use table `agentsam_rules_document` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_script_runs scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema,script generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_script_runs

table_name: `agentsam_script_runs`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: Execution history for registered scripts, including branch/SHA, environment, status, and output summaries.
- Use table `agentsam_script_runs` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'sr_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_scripts scope=agentsam-platform group=cicd-scripts tags=agentsam,cicd-scripts,d1,schema,script generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_scripts

table_name: `agentsam_scripts`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `cicd-scripts`
group_title: `CI/CD Scripts and Automation`
row_count: `96`
tags: `agentsam, cicd-scripts, d1, schema, script`

retrieval_summary:
- Purpose: Registry of automation scripts, runners, safety flags, owner-only requirements, and preferred usage.
- Use table `agentsam_scripts` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_skill scope=agentsam-platform group=memory-skills-rules tags=agentsam,d1,memory-skills-rules,schema,skill generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_skill

table_name: `agentsam_skill`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `memory-skills-rules`
group_title: `Memory, Skills, Rules, and Ignore Patterns`
...
retrieval_summary:
- Purpose: agentsam table in the Memory, Skills, Rules, and Ignore Patterns domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, name, description, file_path, scope, workspace_id, content_markdown.
- Use table `agentsam_skill` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_skill_invocation scope=agentsam-platform group=memory-skills-rules tags=agentsam,d1,memory-skills-rules,schema,skill generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_skill_invocation

table_name: `agentsam_skill_invocation`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `memory-skills-rules`
group_title: `Memory, Skills, Rules, and Ignore Patterns`
...
retrieval_summary:
- Purpose: agentsam table in the Memory, Skills, Rules, and Ignore Patterns domain. Use the actual columns listed here before writing API SQL. Leading columns: id, skill_id, user_id, workspace_id, conversation_id, trigger_method, input_summary, success.
- Use table `agentsam_skill_invocation` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'skillinv_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_skill_revision scope=agentsam-platform group=memory-skills-rules tags=agentsam,d1,memory-skills-rules,schema,skill generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_skill_revision

table_name: `agentsam_skill_revision`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `memory-skills-rules`
group_title: `Memory, Skills, Rules, and Ignore Patterns`
...
retrieval_summary:
- Purpose: agentsam table in the Memory, Skills, Rules, and Ignore Patterns domain. Use the actual columns listed here before writing API SQL. Leading columns: id, skill_id, content_markdown, version, changed_by, change_note, created_at.
- Use table `agentsam_skill_revision` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'skillrev_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_slash_commands scope=agentsam-platform group=commands tags=agentsam,command,commands,d1,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_slash_commands

table_name: `agentsam_slash_commands`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `commands`
group_title: `Commands and Intent Routing`
...
retrieval_summary:
- Purpose: agentsam table in the Commands and Intent Routing domain. Use the actual columns listed here before writing API SQL. Leading columns: id, slug, display_name, description, usage_hint, handler_type, handler_ref, handler_sql.
- Use table `agentsam_slash_commands` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  },
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'[\"ask\",\"agent\",\"auto\",\"debug\",\"plan\"]'",
    "pk": 0
  },
  {
    "cid": 10,
...
<!-- chunk:table name=agentsam_subagent_profile scope=agentsam-platform group=workspace-projects tags=agentsam,d1,schema,workspace-projects generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_subagent_profile

table_name: `agentsam_subagent_profile`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `workspace-projects`
group_title: `Workspaces, Projects, and Subagents`
...
retrieval_summary:
- Purpose: agentsam table in the Workspaces, Projects, and Subagents domain. Use the actual columns listed here before writing API SQL. Leading columns: id, user_id, workspace_id, slug, display_name, instructions_markdown, allowed_tool_globs, default_model_id.
- Use table `agentsam_subagent_profile` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_subscription_registry scope=agentsam-platform group=settings-jobs tags=agentsam,d1,schema,script,settings-jobs generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_subscription_registry

table_name: `agentsam_subscription_registry`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `settings-jobs`
group_title: `Settings, Feature Flags, and Jobs`
...
retrieval_summary:
- Purpose: agentsam table in the Settings, Feature Flags, and Jobs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, name, provider, model_name, subscription_tier, linked_email, notes.
- Use table `agentsam_subscription_registry` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_task_slos scope=agentsam-platform group=observability-analytics tags=agentsam,d1,observability-analytics,schema generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_task_slos

table_name: `agentsam_task_slos`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `observability-analytics`
group_title: `Observability, Analytics, Health, and Errors`
...
retrieval_summary:
- Purpose: agentsam table in the Observability, Analytics, Health, and Errors domain. Use the actual columns listed here before writing API SQL. Leading columns: task_type, sla_p95_latency_ms, sla_avg_cost_usd, sla_min_quality, sla_min_schema_valid_rate, sla_min_tool_success_rate, alert_threshold_pct, notes.
- Use table `agentsam_task_slos` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  {
    "cid": 4,
    "name": "sla_min_schema_valid_rate",
    "type": "REAL",
    "notnull": 0,
    "dflt_value": null,
    "pk": 0
  ...
  {
    "cid": 5,
    "name": "sla_min_tool_success_rate",
    "type": "REAL",
    "notnull": 0,
    "dflt_value": null,
    "pk": 0
...
<!-- chunk:table name=agentsam_todo scope=agentsam-platform group=workflows-plans-tasks tags=agentsam,d1,schema,todo,workflows-plans-tasks generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_todo

table_name: `agentsam_todo`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `workflows-plans-tasks`
group_title: `Workflows, Plans, Tasks, and Todos`
...
retrieval_summary:
- Purpose: agentsam table in the Workflows, Plans, Tasks, and Todos domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, title, description, status, priority, category.
- Use table `agentsam_todo` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_tool_call_log scope=agentsam-platform group=mcp-tools tags=agentsam,d1,mcp-tools,schema,tool generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_tool_call_log

table_name: `agentsam_tool_call_log`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `mcp-tools`
group_title: `MCP Tools, Servers, and Tool Logs`
...
retrieval_summary:
- Purpose: agentsam table in the MCP Tools, Servers, and Tool Logs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, session_id, tool_name, status, duration_ms, error_message, cost_usd.
- Use table `agentsam_tool_call_log` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'atcl_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_tool_chain scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema,tool generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_tool_chain

table_name: `agentsam_tool_chain`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, user_id, agent_id, work_session_id, plan_id, todo_id.
- Use table `agentsam_tool_chain` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'atc_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_tool_stats_compacted scope=agentsam-platform group=mcp-tools tags=agentsam,d1,mcp-tools,schema,tool generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_tool_stats_compacted

table_name: `agentsam_tool_stats_compacted`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `mcp-tools`
group_title: `MCP Tools, Servers, and Tool Logs`
...
retrieval_summary:
- Purpose: agentsam table in the MCP Tools, Servers, and Tool Logs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, tool_name, total_calls, success_count, failure_count, success_rate.
- Use table `agentsam_tool_stats_compacted` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'atsc_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_tools scope=agentsam-platform group=mcp-tools tags=agentsam,d1,mcp-tools,schema,tool generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_tools

table_name: `agentsam_tools`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `mcp-tools`
group_title: `MCP Tools, Servers, and Tool Logs`
...
retrieval_summary:
- Purpose: agentsam table in the MCP Tools, Servers, and Tool Logs domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tool_name, display_name, tool_category, handler_type, description, input_schema, output_schema.
- Use table `agentsam_tools` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'ast_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_usage_events scope=agentsam-platform group=observability-analytics tags=agentsam,d1,observability-analytics,schema,usage generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_usage_events

table_name: `agentsam_usage_events`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `observability-analytics`
group_title: `Observability, Analytics, Health, and Errors`
...
retrieval_summary:
- Purpose: agentsam table in the Observability, Analytics, Health, and Errors domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, user_id, session_id, agent_name, provider, model.
- Use table `agentsam_usage_events` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'ue_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_usage_rollups_daily scope=agentsam-platform group=models-routing-evals tags=agentsam,d1,models-routing-evals,schema,usage generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_usage_rollups_daily

table_name: `agentsam_usage_rollups_daily`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `models-routing-evals`
group_title: `AI Models, Routing, Prompts, and Evals`
...
retrieval_summary:
- Purpose: agentsam table in the AI Models, Routing, Prompts, and Evals domain. Use the actual columns listed here before writing API SQL. Leading columns: tenant_id, workspace_id, day, ai_calls, tokens_in, tokens_out, cost_usd, tool_calls.
- Use table `agentsam_usage_rollups_daily` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
<!-- chunk:table name=agentsam_user_feature_override scope=agentsam-platform group=security-governance tags=agentsam,d1,feature,schema,security-governance generated_at=2026-05-07T05:17:18.222090+00:00 -->
...
retrieval_summary:
- Purpose: agentsam table in the Security, Guardrails, Policy, and Approvals domain. Use the actual columns listed here before writing API SQL. Leading columns: user_id, flag_key, enabled, updated_at, person_uuid.
...
<!-- chunk:table name=agentsam_user_policy scope=agentsam-platform group=security-governance tags=agentsam,d1,policy,schema,security-governance generated_at=2026-05-07T05:17:18.222090+00:00 -->
...
retrieval_summary:
- Purpose: agentsam table in the Security, Guardrails, Policy, and Approvals domain. Use the actual columns listed here before writing API SQL. Leading columns: user_id, workspace_id, auto_run_mode, browser_protection, mcp_tools_protection, file_deletion_protection, external_file_protection, default_agent_location.
...
<!-- chunk:table name=agentsam_webhook_events scope=agentsam-platform group=hooks-webhooks tags=agentsam,d1,hook,hooks-webhooks,schema,webhook generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_webhook_events

table_name: `agentsam_webhook_events`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `hooks-webhooks`
group_title: `Hooks and Webhooks`
...
retrieval_summary:
- Purpose: Inbound webhook event log and processing state.
- Use table `agentsam_webhook_events` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'whe_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_webhook_weekly scope=agentsam-platform group=hooks-webhooks tags=agentsam,d1,hook,hooks-webhooks,schema,webhook generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_webhook_weekly

table_name: `agentsam_webhook_weekly`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `hooks-webhooks`
group_title: `Hooks and Webhooks`
...
retrieval_summary:
- Purpose: agentsam table in the Hooks and Webhooks domain. Use the actual columns listed here before writing API SQL. Leading columns: id, tenant_id, workspace_id, week_start, week_end, provider, total_received, total_processed.
- Use table `agentsam_webhook_weekly` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'whw_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_workflow_runs scope=agentsam-platform group=execution tags=agentsam,d1,execution,schema,workflow generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_workflow_runs

table_name: `agentsam_workflow_runs`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `execution`
group_title: `Agent Execution`
...
retrieval_summary:
- Purpose: agentsam table in the Agent Execution domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workflow_id, workflow_key, display_name, tenant_id, workspace_id, project_id, user_id.
- Use table `agentsam_workflow_runs` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'wrun_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
...
<!-- chunk:table name=agentsam_workspace scope=agentsam-platform group=workspace-projects tags=agentsam,d1,schema,workspace,workspace-projects generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_workspace

table_name: `agentsam_workspace`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `workspace-projects`
group_title: `Workspaces, Projects, and Subagents`
...
retrieval_summary:
- Purpose: Workspace-level configuration for Agent Sam, including project/repo/R2/model/subagent context.
- Use table `agentsam_workspace` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  ...
  },
  {
    ...
    "type": "TEXT",
    "notnull": 1,
    "dflt_value": "'tenant_inneranimalmedia'",
    "pk": 0
  },
  {
    "cid": 3,
...
<!-- chunk:table name=agentsam_workspace_state scope=agentsam-platform group=workspace-projects tags=agentsam,d1,schema,workspace,workspace-projects generated_at=2026-05-07T05:17:18.222090+00:00 -->

## schema.table.agentsam_workspace_state

table_name: `agentsam_workspace_state`
database: `inneranimalmedia-business`
scope: `agentsam-platform`
group: `workspace-projects`
group_title: `Workspaces, Projects, and Subagents`
...
retrieval_summary:
- Purpose: agentsam table in the Workspaces, Projects, and Subagents domain. Use the actual columns listed here before writing API SQL. Leading columns: id, workspace_id, conversation_id, workspace_type, active_file, files_open, state_json, locked_by.
- Use table `agentsam_workspace_state` only with the columns listed below.
- Do not guess tenant/workspace/user/model/tool columns unless they appear here.
- If an API query fails with a missing column, patch the query against this context rather than inventing migrations.
...
[
  {
    ...
    "type": "TEXT",
    "notnull": 0,
    "dflt_value": "'wss_' || lower(hex(randomblob(8)))",
    "pk": 1
  },
  {
    "cid": 1,
