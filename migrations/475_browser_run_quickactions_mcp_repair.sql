-- 475: Repair Browser Run Quick Actions MCP tool rows (474 omitted workspace_scope NOT NULL)
-- Apply: ./scripts/with-cloudflare-env.sh npx wrangler d1 execute inneranimalmedia-business --remote -c wrangler.production.toml --file=./migrations/475_browser_run_quickactions_mcp_repair.sql
...
INSERT OR REPLACE INTO agentsam_mcp_tools (
  ...
  (
    ...
    '{"type":"object","required":["url"],"properties":{"url":{"type":"string","description":"URL to fetch as markdown"},"wait_for_network":{"type":"boolean","default":false,"description":"Wait for networkidle2 before capturing. Slower but more complete for JS-heavy pages."}}}',
    'low',
    0,
    1,
    1,
  ...
  (
    ...
    '{"type":"object","required":["url"],"properties":{"url":{"type":"string","description":"Starting URL to crawl"},"limit":{"type":"integer","default":20,"maximum":100},"depth":{"type":"integer","default":3,"maximum":10},"render":{"type":"boolean","default":false,"description":"false = fast static fetch, true = full JS render (costs browser time)"},"include_subdomains":{"type":"boolean","default":false},"include_external":{"type":"boolean","default":false},"include_patterns":{"type":"array","items":{"type":"string"}},"exclude_patterns":{"type":"array","items":{"type":"string"}}}}',
    'medium',
    0,
    1,
    1,
  ...
  (
    ...
    '{"type":"object","required":["url","prompt"],"properties":{"url":{"type":"string"},"prompt":{"type":"string","description":"What data to extract. Be specific about where it appears on the page."},"schema":{"type":"object","description":"JSON schema defining the expected output structure"}}}',
    'low',
    0,
    1,
    1,
...
-- Ensure OAuth allowlist rows exist (474 may have already applied)
