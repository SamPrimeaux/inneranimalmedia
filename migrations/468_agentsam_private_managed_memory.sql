...
INSERT INTO agentsam_memory (
  ...
  'error', 'error:mcp_memory_save_401_reauth',
  'ChatGPT attempted agentsam_memory_save but IAM MCP returned 401 reauthentication required.',
  'MCP memory save failed due to reauthentication required',
  'MCP 401 on agentsam_memory_save — reauth IAM connector.',
...
INSERT INTO agentsam_memory (
  ...
  'tenant_sam_primeaux', 'au_871d920d1233cbd1', 'ws_inneranimalmedia',
  'project', 'milestone:20260529_runtime_security_public_learning_r2',
