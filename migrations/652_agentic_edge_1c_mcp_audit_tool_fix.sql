-- 652: Fix agentsam_mcp_audit — handler_type must be in agentsam_tools CHECK (use telemetry lane).
--
-- Apply:
--   ./scripts/with-cloudflare-env.sh npx wrangler d1 execute inneranimalmedia-business \
--     --remote -c wrangler.production.toml --file=./migrations/652_agentic_edge_1c_mcp_audit_tool_fix.sql
...
INSERT OR IGNORE INTO agentsam_mcp_oauth_tool_allowlist (
  ...
  'read',
  12,
  '652: read-only mcp_audit_log query for operator diagnostics',
  1,
  1,
  12,
  unixepoch()
