...
const CAPABILITY_GROUPS = (() => {
  ...
  return [
    ...
    g(['d1.read', 'd1_read', 'd1_query'], ['d1_query']),
    g(['d1.write', 'd1_write'], ['d1_write']),
    g(['d1.batch_write', 'd1_batch_write'], ['d1_write']),
    ...
    g(['knowledge_search'], ['knowledge_search', 'ss_search_knowledge']),
    g(['context_search'], ['context_search', 'context_chunk', 'context_summarize_code']),
    g(['memory_read'], ['agent_memory_search']),
