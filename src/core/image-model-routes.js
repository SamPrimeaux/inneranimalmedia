...
export const IMAGE_GENERATION_LANES = Object.freeze({
  ...
  fast_draft: {
    preferredModels: ['gemini-3.1-flash-image', 'gpt-image-1', '@cf/black-forest-labs/flux-2-klein-4b'],
  ...
  high_quality: {
    preferredModels: ['gemini-3-pro-image', 'gpt-image-2', 'gpt-image-1'],
    googleDefault: GOOGLE_MODEL_ROUTES.imagePro,
  },
  /** Reference edit / inpaint — imgx_edit_image (OpenAI edit path today). */
  edit_reference: {
    preferredModels: ['gpt-image-1', 'gpt-image-1.5', 'gemini-3.1-flash-image'],
    googleDefault: GOOGLE_MODEL_ROUTES.imageFast,
  },
});
...
export const IMAGE_CAPABLE_SURFACES = Object.freeze([
  ...
  { id: 'openai_gpt_image_1', model: 'gpt-image-1', task_type: 'image_generation', tool: 'imgx_generate_image' },
  ...
  { id: 'cms_theme_cover', model: 'gpt-image-1', task_type: 'cms_theme_cover', tool: null },
