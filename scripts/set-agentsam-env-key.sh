...
case "$KEY" in
  SUPABASE_SERVICE_ROLE_KEY|SUPABASE_ANON_KEY|SUPABASE_URL|SUPABASE_PROJECT_REF|GOOGLE_AI_API_KEY|GEMINI_API_KEY|OLLAMA_BASE_URL|OLLAMA_DEFAULT_MODEL|AGENTSAM_LOCAL_MODEL_ENABLED|IAM_IDENTITY_PROFILE_ID|IAM_SUPABASE_USER_ID|IAM_D1_AUTH_USER_ID|IAM_USER_EMAIL|IAM_PERSON_UUID|IAM_SUPERADMIN_UUID|AGENTSAM_SUPABASE_STRICT)
    ;;
  *)
