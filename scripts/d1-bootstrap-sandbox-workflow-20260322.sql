...
INSERT OR REPLACE INTO r2_buckets (
  ...
  'Dashboard static mirror for UI iteration; production bucket remains inneranimalmedia. Region WNAM.',
  'wnam',
  0,
  'https://ede6590ac0d2fb7daf155b35653457b2.r2.cloudflarestorage.com/inneranimalmedia-sandbox-cidi',
  'https://catalog.cloudflarestorage.com/ede6590ac0d2fb7daf155b35653457b2/inneranimalmedia-sandbox-cidi',
  'ede6590ac0d2fb7daf155b35653457b2_inneranimalmedia-sandbox-cidi',
...
INSERT OR REPLACE INTO mcp_workflows (
  ...
  'Step 1: sync repo dashboard + Vite outputs to inneranimalmedia-sandbox-cidi (./scripts/upload-repo-to-r2-sandbox.sh). Step 2: after Sam approval, promote agent shell + bundle to inneranimalmedia (PROMOTE_OK=1 ./scripts/promote-agent-dashboard-to-production.sh). Worker deploy only with deploy approved. Full playbook: docs/CURSOR_HANDOFF_D1_CICD_ORCHESTRATION.md',
  'deploy',
  'manual',
  '{"repo":"march1st-inneranimalmedia","sandbox_bucket":"inneranimalmedia-sandbox-cidi","prod_bucket":"inneranimalmedia"}',
...
UPDATE worker_registry SET
  ...
  r2_buckets = '["inneranimalmedia-sandbox-cidi","inneranimalmedia-sandbox-cidi"]',
  bindings_count = 3,
  notes = COALESCE(notes, '') || ' | CI/CD: R2 sandbox inneranimalmedia-sandbox-cidi (DASHBOARD+ASSETS); promote via scripts/promote-agent-dashboard-to-production.sh after approval.',
