/**
 * Worker / ExecOS / Design Studio code paths for milestone CODE lane reindex.
 * Git-tracked paths only — used by reindex_milestone_worker_code.mjs
 */
export const MILESTONE_WORKER_CODE_PATHS = Object.freeze([
  ...
  'dashboard/components/designstudio/CadJobPanel.tsx',
  'dashboard/components/designstudio/BlueprintPanel.tsx',
  'dashboard/components/designstudio/CadToolDock.tsx',
  'dashboard/components/designstudio/creation-station/DesignStudioCreationStation.tsx',
]);
