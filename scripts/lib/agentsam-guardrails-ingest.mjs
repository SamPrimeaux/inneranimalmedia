...
export function guardrailDocumentMetadata(r, scope) {
  return {
    ...
    ruleset_id: r.ruleset_id != null ? String(r.ruleset_id) : null,
    ruleset_key: r.ruleset_key != null ? String(r.ruleset_key) : null,
    ruleset_name: r.ruleset_name != null ? String(r.ruleset_name) : null,
