...
import { ArtStyle, type GenerationConfig, type SceneConfig } from '../../types';
...
export function SandboxToolDock({ genConfig, onUpdateGenConfig, sceneConfig, onUpdateSceneConfig }: Props) {
  return (
