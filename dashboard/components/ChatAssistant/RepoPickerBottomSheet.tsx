...
export function RepoPickerBottomSheet({
  ...
  useEffect(() => {
    if (!open || view !== 'files' || !browseRepo) return;
    void loadDirectory(browseRepo, browseBranch, browsePath);
  }, [open, view, browseRepo, browseBranch, browsePath, loadDirectory]);
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-[14px] font-semibold text-[var(--dashboard-text)] truncate">
                {view === 'files' ? browseRepo || 'Files' : 'Connect GitHub'}
              </h3>
              {view === 'files' ? (
                ...
                <p className="text-[11px] text-[var(--dashboard-muted)]">
                  Pick a repo for this chat — your connected GitHub account
                </p>
              )}
            </div>
          </div>
                ...
                <div className="space-y-3 px-2 py-6 text-center">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      window.location.href = `/api/oauth/github/start?return_to=${returnTo}`;
                    }}
