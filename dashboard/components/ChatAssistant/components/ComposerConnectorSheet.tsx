...
export function ComposerConnectorSheet({
  ...
  return (
    <div
      className="flex w-[min(340px,calc(100vw-2rem))] max-h-[min(480px,70dvh)] flex-col overflow-hidden rounded-2xl border border-[var(--dashboard-border)] bg-[var(--dashboard-panel)] text-[0.8125rem] shadow-xl"
      style={style}
      role="menu"
    >
