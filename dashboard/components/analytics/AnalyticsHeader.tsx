  ...
  return (
    <header className="ov-header shrink-0">
      <div className="ov-title">
        <div className="text-[11px] uppercase tracking-wide text-[var(--text-muted)]">Analytics cockpit</div>
        <h1 className="ov-h1">{title}</h1>
        <p className="ov-sub">{subtitle}</p>
      </div>
      <div className="ov-actions">
        {updated ? <div className="text-[11px] text-[var(--text-muted)]">Layout updated {updated}</div> : null}
      </div>
    </header>
  );
};
