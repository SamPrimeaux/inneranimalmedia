    ...
    <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 border-b border-[var(--dashboard-border)] px-6 py-5 bg-[var(--dashboard-canvas)]">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <h1 className="text-xl font-semibold text-[var(--text-primary)] tracking-tight">Library</h1>
            <p className="text-sm text-[var(--text-muted)] mt-1 max-w-2xl">
              Artifacts generated by Agent Sam, workflows, tests, visualizers, and command runs.
            </p>
          </div>
        ...
        {err ? (
          ...
          <div className="max-w-md py-16 text-center mx-auto">
            ...
            <p className="text-sm text-[var(--text-muted)] mt-2">
              Generate an artifact from Agent Sam chat, a workflow, or a smoke test and it will appear here.
            </p>
          </div>
        ) : (
          <ArtifactGrid
